...
<?php //การนำข้อมูลที่ลูกค้ากรอกมา เพิ่มไปยัง database contact table น.ส.ชาลิสา เพ็ชรสีทอง 6130613050
$name = $_POST['name'];
$email = $_POST['email'];
$subject = $_POST['subject'];
$massage = $_POST['message'];
$connect = mysqli_connect("localhost","root","","class");
$sql = 'INSERT INTO contact VALUES("","'.$name.'","'.$email.'","'.$subject.'","'.$massage.'")';
$result = mysqli_query($connect,$sql);
if (!$result) {
    echo mysqli_error().'<br>';
    die('Can not access database!');
}else{
    echo '<h1 size="150">Thank You</h1>';
}
...
<div class="box">
            <p align="center">
            <input type='reset' value= 'Back' class="btn btn-warning" onClick="window.location='http://www.localhost/Project/contact.php';" />
