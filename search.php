...
<div class="container update">
    <h1 align="center">SEARCH INFORMATION </h1>

    <div class="search">
        <div>
<?php //การแสดง table ที่เราสามารถที่จะหาข้อมูลได้ น.ส.ชาลิสา เพ็ชรสีทอง 6130613050
        echo '<form name="search" action="search2.php" method="post">';
...
echo '<input type="submit" class="btn-search" name="table" value="room">';
echo '</form>';
?>
        </div>
        <div>
<?php
        ...
        echo '<input type="submit" class="btn-search" name="table" value="contact">';
        echo '</form>';
        ?>
        </div>
